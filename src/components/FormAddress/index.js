...
const FormAddress = ({ handleAddresses, closeModal, showModalUf, showModalMunicipio, showModalBairro}) => {
    ...
    const handleSaveAddresses = (e) => {
        e.preventDefault();
        if (validaForm()) {
            // setEndereco(prevEndereco => ({ ...prevEndereco, id: crypto.randomUUID().toString() }));
            handleAddresses(endereco);
        ...
        <div>
                ...
                <div className='row'>
                    <div className="form-group col-md-4 mb-3">
                        ...
                        <div className='d-flex'>
                            ...
                            >
                                <option defaultValue value={endereco.codigoUf}>Selecione uma UF</option>
                                {state.map((uf) => {
                    ...
                    <div className="form-group col-md-4 mb-3">
                        ...
                        <div className='d-flex'>
                            <select id="inputMunicipio" className="form-select" name='codigoMunicipio' onChange={(e) => {
                                ...
                                <option defaultValue value={endereco.codigoMunicipio}>Selecione um município</option>
                    ...
                    <div className="form-group col-md-4 mb-3">
                        ...
                        <div className='d-flex'>
                            <select id="inputBairro" className="form-select" name='codigoBairro'  onChange={(e) => {
                                ...
                                <option defaultValue value={0}>Selecione um bairro</option>
            ...
            <div className="">
                <button className='btn btn-success border-0 p-2 mx-3 mt-2 mb-2 flex-row'
                    ...
                    }}><AddCircleOutlineIcon /> SALVAR ENDEREÇO</button>
            </div>
        </div>
